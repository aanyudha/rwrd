...
MySQL - 8.0.39-0ubuntu0.24.04.1 : Database - rwrd
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`rwrd` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `general_settings` (
  ...
  `show_latest_posts_on_full` tinyint(1) DEFAULT '0',
  ...
  `post_format_full` tinyint(1) DEFAULT '1',
  ...
  `sort_full_posts` varchar(100) DEFAULT 'by_full_order',
  PRIMARY KEY (`id`)
...
CREATE TABLE `mst_member` (
  ...
  `id_tipe_member` int NOT NULL DEFAULT '1',
  `is_print_card` enum('Yes','No') DEFAULT 'No',
  `initial_point` int DEFAULT NULL,
  `initial_number_of_stays` int DEFAULT NULL,
...
CREATE TABLE `posts` (
  ...
  `full_order` tinyint(1) DEFAULT '1',
  `visibility` tinyint(1) DEFAULT '1',
...
/*Table structure for table `ref_identitas` */
...
CREATE TABLE `ref_konversi` (
  `id_ref_konversi` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ref_negara` (
  `id_negara` varchar(3) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
/*Table structure for table `ref_pilih` */

DROP TABLE IF EXISTS `ref_pilih`;

CREATE TABLE `ref_pilih` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ref_tipe_member` (
  `id_tipe_member` int NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) NOT NULL,
  `index` decimal(4,2) NOT NULL,
  `min_stays` int NOT NULL,
  `max_stays` int NOT NULL,
...
CREATE TABLE `settings` (
  ...
  `primary_font` smallint DEFAULT '19',
  `secondary_font` smallint DEFAULT '25',
  `tertiary_font` smallint DEFAULT '32',
...
CREATE TABLE `trn_hotel` (
  `id_trn` int NOT NULL AUTO_INCREMENT,
  ...
  `room_revenue` int NOT NULL,
  `fnb_revenue` int NOT NULL,
  `other_revenue` int NOT NULL,
  `total_revenue` int NOT NULL,
  `room_revenue_converted` int NOT NULL,
  `fnb_revenue_converted` int NOT NULL,
  `other_revenue_converted` int NOT NULL,
  `total_revenue_converted` int NOT NULL,
  ...
  PRIMARY KEY (`id_trn`)
) ENGINE=InnoDB AUTO_INCREMENT=39349 DEFAULT CHARSET=latin1;
...
CREATE TABLE `trn_point_in_saved` (
  `id_point_in` int NOT NULL AUTO_INCREMENT,
  `id_member` varchar(20) NOT NULL,
  `point` int NOT NULL,
...
CREATE TABLE `trn_point_konversi` (
  `id_point_konversi` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `trn_point_out` (
  `id_point_out` int NOT NULL AUTO_INCREMENT,
  `id_member` varchar(20) NOT NULL,
  `id_reward` int NOT NULL,
  `qty` int NOT NULL,
  `point` int NOT NULL,
...
CREATE TABLE `trn_reward` (
  `id_trn_reward` int NOT NULL AUTO_INCREMENT,
  `id_reward` int NOT NULL,
...
/*Table structure for table `trn_status` */

DROP TABLE IF EXISTS `trn_status`;

CREATE TABLE `trn_status` (
  `id` int NOT NULL AUTO_INCREMENT,
