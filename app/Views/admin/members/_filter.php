...
<div class="row table-filter-container">
    <div class="col-sm-12">
        <form action="<?= adminUrl('members'); ?>" method="get">
            ...
            <div class="item-table-filter">
                ...
                <select name="status" class="form-control">
                    ...
                    <option value="Aktif" <?= inputGet('status', true) == 'Aktif' ? 'selected' : ''; ?>><?= trans("aktif"); ?></option>
                    <option value="Non Aktif" <?= inputGet('status', true) != null && inputGet('status', true) != 'Aktif' ? 'selected' : ''; ?>><?= trans("non_aktif"); ?></option>
                </select>
            </div>
